    ...
    <div className="gallery-container">
      <div className="gallery-header">
        ...
        <div className="gallery-arrows desktop-only">
          <button onClick={prev} className="arrow-btn dark" disabled={index === 0}>‹</button>
          <button onClick={next} className="arrow-btn orange" disabled={index === images.length - 1}>›</button>
        </div>
      </div>
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .mobile-only {
            ...
            margin-top: 15px;
            margin-bottom: 10px; /* adds a little space from the bottom */
          }
        }
