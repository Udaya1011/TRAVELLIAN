...
export default function Hero() {
  ...
  return (
    <header
      className="hero-container" style={{ backgroundImage: `url(${HERO_BG})` }}>
...
>
      ...
      <ul className={`nav-links ${menuOpen ? "open" : ""}`}>
          ...
          <li onClick={handleLinkClick}>Explore</li>
          <li onClick={handleLinkClick}>Travel</li>
          <li onClick={handleLinkClick}>Blog</li>
          <li onClick={handleLinkClick}>Pricing</li>
      </ul>
      ...
      <div className="booking-box">
        ...
        <button
          className="book-btn"
          onClick={() => alert("Thanks for booking!")}
        >
          Book Now →
        </button>
      </div>
