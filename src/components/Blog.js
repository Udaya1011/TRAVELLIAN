    ...
    <div className="blog-container">
      ...
      <div className="blog-post-card">
        <div className="post-image-wrapper">
          <img
            src="https://i.pinimg.com/1200x/f6/49/22/f64922eda08ec679dee8eee456d4b13e.jpg"
            alt="Beautiful Italy"
        ...
        <div className="post-content">
          <h2 className="post-title-main">Beautiful Italy</h2>
          <h3 className="post-subtitle-main">Let's travel</h3>
